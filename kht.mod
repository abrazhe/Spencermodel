...
PARAMETER {
        v (mV)
        celsius = 33 (degC) :O 33 from Spencer et al., 2012
        ...
        gkhtbar = 0.0061 (mho/cm2) <0,1e9>  :O  value for soma (Bal & Oertel 2001) from Spencer et al., 2012
